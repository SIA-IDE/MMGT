...
def log_validation(
    ...
    vae = vae.to(dtype=reference_unet.dtype) # yy
    image_enc = image_enc.to(dtype=reference_unet.dtype) # yy    
    ...
    ref_image_paths = [
        "./configs/inference/images/frame_0005.png",
        "./configs/inference/images/frame_0069.png",
    ]
    pose_image_paths = [
        "./configs/inference/pose_image/frame_0003.jpg",
        "./configs/inference/pose_image/frame_0024.jpg",
    ]
...
def main(cfg):
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset, batch_size=cfg.data.train_bs, shuffle=True, num_workers=2
    )
